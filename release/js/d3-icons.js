...
function coords(cx,cy,r,degree)
{ 
   var scaleY = d3.scaleLinear()
                  .domain([0,100])
                  .range([100,0]); 
   var x = cx + r * Math.cos(d2r(degree));
   var y = cy + scaleY(r * Math.sin(d2r(degree))); 
   return {"x":x,"y":y};
}
...
IconMaker.prototype.init = function()
{
    ...
    //console.log("Svg container props "+ width+ "  "+height);
...
IconMaker.prototype.add = function(d, node)
{
    ...
    { 
        ...
        if (d.hasOwnProperty("fill-opacity"))
            shape.attr("fill-opacity",d["fill-opacity"]);
...
IconMaker.prototype.iconData = function(name)
{
    ...
    switch (name) 
    {
      ...
      case "next":
        data = [{"shape":"circle","cx":50,"cy":50,"r":33,"stroke":"#666","stroke-width":4,"fill":"none"},
                {"shape":"line","x1":52,"y1":36, "x2":65,"y2":50,"stroke-width":6,"stroke-linecap":"round","stroke":"#666","class":"action"},
                {"shape":"line","x1":52,"y1":64, "x2":65,"y2":50,"stroke-width":6,"stroke-linecap":"round","stroke":"#666","class":"action"},
                {"shape":"circle","cx":47,"cy":50, "r":3.5,"fill":"#666","class":"action"},
                {"shape":"circle","cx":35,"cy":50, "r":3.5,"fill":"#666","class":"action"}];
        break;
        case "back":
          data = [{"shape":"circle","cx":50,"cy":50,"r":33,"stroke":"#666","stroke-width":4,"fill":"none"},
                  {"shape":"line","x1":48,"y1":36, "x2":35,"y2":50,"stroke-width":6,"stroke-linecap":"round","stroke":"#666","class":"action"},
                  {"shape":"line","x1":48,"y1":64, "x2":35,"y2":50,"stroke-width":6,"stroke-linecap":"round","stroke":"#666","class":"action"},
                  {"shape":"circle","cx":53,"cy":50, "r":3.5,"fill":"#666","class":"action"},
                  {"shape":"circle","cx":65,"cy":50, "r":3.5,"fill":"#666","class":"action"}];
          break;
      case "add":
        data = [{"shape":"circle","cx":50,"cy":50,"r":33,"stroke":"#666","stroke-width":4,"fill":"none"},
                {"shape":"circle","cx":50,"cy":50,"r":27,"fill":"#ccc","fill-opacity":.5,"class":"action"},
                {"shape":"line","x1": 37,"x2":63,"y1":50,"y2":50,"stroke-width":8,"stroke-linecap":"round","stroke":"#666","class":"action"},
                {"shape":"line","y1": 37,"y2":63,"x1":50,"x2":50,"stroke-width":8,"stroke-linecap":"round","stroke":"#666","class":"action"}];
        break;
      case "delete":
        data = [{"shape":"circle","cx":50,"cy":50,"r":33,"stroke":"#666","stroke-width":4,"fill":"none"},
      ...
      case "search":
        ...
        break;
      case "toggle":
        data = [{"shape":"path","d":"M 60 50 L 20 20 L 20 80 L 60 50","fill":"#999","stroke":"#999","class":"hide"},
                {"shape":"path","d":"M 50 80 L 20 40 L 80 40 L 50 80","fill":"#999","stroke":"#999","class":"show"}];
        break;
      case "progress":
...
function addIcon(element,name,handle,shapes)
{
   var el = new IconMaker(element,name,handle,shapes);
   return el; 
}